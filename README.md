...
Plugin lua files can be placed in the lua/betterchat\_plugins folder. These will be automatically networked and loaded on client and server based on the name.  
